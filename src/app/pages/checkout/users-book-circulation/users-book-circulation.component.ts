...
@Component({
  selector: 'app-users-book-circulation',
  imports: [ CommonModule, TagModule, TableModule, ButtonModule, FormsModule, PaginatorModule, 
        MultiSelectModule, DialogModule, InputTextModule, SelectModule, DatePickerModule, TooltipModule, IssueReturnBooksComponent],
  templateUrl: './users-book-circulation.component.html',
  styleUrl: './users-book-circulation.component.scss'
})
...
//     public lstBookDetails: BookDetails[] = [];
    ...
    editBook(_bcd: BookCirculationDetails | null = null, bcType: string): void {
        ...
        {
            this.bc  = { BookCirculationId: 0, BookId: 0,  BookName: '', BorrowerId: this.selectedUserDetails.UserId, BorrowerName : this.selectedUserDetails.FullName, 
