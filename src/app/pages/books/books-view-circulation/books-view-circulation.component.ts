...
import { BookCirculationDetails, UserDetails, BookDetails, TransactionTypeDetails } from '@app/shared/models/api.models';
...
export class BooksViewCirculationComponent {
    @Input() selectedMainBook : BookDetails = {
        BookId: 0,
        BookName: '',
        AuthorId: null,
        AuthorName: '',
    ...
    // @Input() selectedBookStatus = "Available";
